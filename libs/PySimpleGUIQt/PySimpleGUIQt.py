...
version = "5.0.0 Released 10-Feb-2024"
...
5.0.0   10-Feb-2024     Final PySimpleGUI 5 release!
...
import sys, datetime, textwrap, pickle, random, warnings, time, webbrowser
...
try:
    ...
    qt_version = 6
except ImportError as pyside_6_import_error:
    try:
        ...
        # print("PySide6 not found, using PySide2 instead.")
        qt_version = 5
    except ImportError as pyside_2_import_error:
        raise ImportError("PySimpleGUIQt requires either PySide6 or PySide2")

def pyside_exec(app: QApplication):
    '''
        executes the QApplication depending on the pyside version used
    '''
    if qt_version == 5:
        app.exec_()
    elif qt_version == 6:
...
class Element():
    ...
    def __init__(self, elem_type, size=(None, None), auto_size_text=None, font=None, background_color=None, text_color=None,
        ...
        :param elem_type:        The type of element. These constants all start with "ELEM_TYPE_"
        :type elem_type:         (int) (could be enum)
        ...
        :type visible:           (bool)
        :param size_px:          w=pixels-wide, h=pixels-high
    ...
    _FindReturnKeyBoundButton = _find_return_key_bound_button
    _ReturnKeyHandler = _return_key_handler
    Update = update
...
class InputText(Element):
    ...
    def _qt_callback_focus_in_event(self, value):
        """
        Not user callable!
        """
    ...
    def _qt_callback_return_pressed(self):
    ...
    _dragEnterEvent = _drag_enter_event
    _dropEvent = _drop_event
    _QtCallbackFocusInEvent = _qt_callback_focus_in_event
    _QtCallbackReturnPressed = _qt_callback_return_pressed
    Update = update
    Get = get
    SetFocus = set_focus
...
class Combo(Element):
    ...
    def __init__(self, values, default_value=None, size=(None, None), auto_size_text=None, background_color=None,
        ...
        :type readonly:          (bool)
        :param visible_items:    Amount of visible items
        :type visible_items:     (int)
        :param font:             specifies the font family, size, etc. Tuple or Single string format 'name size styles'. Styles: italic * roman bold normal underline overstrike
        :type font:              (str or (str, int[, str]) or None)
        :param auto_complete:    Turn on auto complete
    ...
    def _qt_current_item_changed(self, state):
        """
        Not user callable!
        """
    ...
    _QtCurrentItemChanged = _qt_current_item_changed
    Update = update
...
class Listbox(Element):
    ...
    def _qt_current_row_changed(self, state):
        """
        Not user callable!
        """
    ...
    _QtCurrentRowChanged = _qt_current_row_changed
    Update = update
    SetValue = set_value
...
class Radio(Element):
    ...
    def _qt_callback_value_changed(self, value):
        """
        Not user callable!
        """
    ...
    Update = update
    _QtCallbackValueChanged = _qt_callback_value_changed
...
class Checkbox(Element):
    ...
    def _qt_callback_state_changed(self, state):
        """
        Not user callable!
        """
    ...
    _QtCallbackStateChanged = _qt_callback_state_changed
    Get = get
    Update = update
...
class Spin(Element):
    ...
    class StringBox(QSpinBox):
        ...
        def text_from_value(self, value):
            return str(self._strings[value])

        def value_from_text(self, text):
            return self._values[text]

        setStrings = set_strings
        textFromValue = text_from_value
...
class Multiline(Element):
    ...
    def _qt_callback_focus_in_event(self):
        """
        Not user callable!
        """
...
class Text(Element):
    ...
    def _qt_callback_text_clicked(self, event):
        """
        Not user callable!
        """
    ...
    _QtCallbackTextClicked = _qt_callback_text_clicked
    Update = update
...
class Output(Element):
    ...
    def _reroute_stdout(self):
        """
        Internal function used for rerouting output
        """
...
class Button(Element):
    ...
    def __init__(self, button_text='', button_type=BUTTON_TYPE_READ_FORM, target=(None, None), tooltip=None,
        ...
        :type border_width:      (int)
        :param size:             (w, h) w=characters-wide, h=rows-high
        :type size:              (int | None, int | None)  | (None, None)
    ...
    def _button_release_call_back(self, parm):
        """
        Not a user callable function.  Called when a "realtime" button is released

        :param parm: Event info
        :type parm:
    ...
    def _button_press_call_back(self, parm):
        """
        Not a user callable method. Callback called when a "realtime" button is pressed
    ...
    def click(self):
        ...
        Calls the invoke method for the button
        """
    ...
    _ButtonReleaseCallBack = _button_release_call_back
    _ButtonPressCallBack = _button_press_call_back
    _ButtonCallBack = _button_call_back
    Update = update
    GetText = get_text
    SetFocus = set_focus
    Click = click
...
class ButtonMenu(Element):
    ...
    def _qt_menu_item_chosen_callback(self, item_chosen):
        """
        Not user callable!
        """
    ...
    def update(self, menu_definition=None, text=None, button_color=(None, None), font=None, visible=None):
        ...
        if menu_definition is not None:
            ...
            _AddMenuItem(qmenu, menu_def[1], self)
    ...
    _QT_MenuItemChosenCallback = _qt_menu_item_chosen_callback
    Update = update
    Click = click
...
class Image(Element):
    ...
    def __init__(self, filename=None, data=None, data_base64=None, background_color=None, size=(None, None), pad=None, key=None, k=None, tooltip=None, click_submits=False,  enable_events=False, visible=True, size_px=(None,None), metadata=None):
        ...
        :param data_base64:      base64 encoded string
    ...
    def _qt_callback_image_clicked(self, event):
        """
        Not user callable!
        """
    ...
    _QtCallbackImageClicked = _qt_callback_image_clicked
    Update = update
...
class Canvas(Element):
    ...
    def __init__(self, canvas=None, background_color=None, size=(None, None), pad=None, key=None, k=None, tooltip=None, metadata=None):
        """
        :param canvas:           Your own Canvas if you already created it. Leave blank to create a Canvas
        :type canvas:            (tk.Canvas) | None
        :param background_color: color of background. Can be in #RRGGBB format or a color name "black"
        :type background_color:  (str)
...
class Graph(Element):
    ...
    def draw_rectangle(self, top_left, bottom_right, fill_color=None, line_color=None):
        """
    ...
    def draw_circle(self, center_location, radius, fill_color=None, line_color='black'):
        """
    ...
    def relocate_figure(self, id, x, y):
        """
        Moves a previously drawn figure using a "delta" from current position

        :param id: Previously obtained figure-id. These are returned from all Draw methods
        :type id:  (id)
        :param x:  delta to apply to position in the X direction
        :type x:   int | float
        :param y:  delta to apply to position in the Y direction
        :type y:   int | float
        """
    ...
    def draw_text(self, text, location, color='black', font=None, angle=0):
        """
    ...
    def draw_oval(self, top_left, bottom_right, fill_color=None, line_color=None):
        """
    ...
    def draw_arc(self, top_left, bottom_right, extent, start_angle, style=None, arc_color='black'):
        """
    ...
    def draw_rectangle_old(self, top_left, bottom_right, fill_color=None, line_color=None):
        """
        Draw a rectangle given 2 points. Can control the line and fill colors
    ...
    def change_coordinates(self, graph_bottom_left, graph_top_right):
        """
        Changes the coordinate system to a new one.  The same 2 points in space are used to define the coorinate
    ...
    DrawArc = draw_arc
    DrawRectangleOld = draw_rectangle_old
    Erase = erase
    Update = update
...
class Frame(Element):
    ...
    def _get_element_at_location(self, location):
        """
    ...
    AddRow = add_row
    Layout = layout
    _GetElementAtLocation = _get_element_at_location
    Update = update
...
class TabGroup(Element):
    ...
    def update(self, visible=None):
        """
        Changes some of the settings for the Tab Group Element. Must call `Window.Read` or `Window.Finalize` prior
...
class Slider(Element):
    ...
    def update(self, value=None, range=(None, None), disabled=None, visible=None):
        ...
        :param range:    slider's range (min value, max value)
        :type range:     (int, int), (float, float)
        :param disabled: disable or enable state of the element
        :type disabled:  (bool)
        :param visible:  control visibility of element
        :type visible:   (bool)
...
class Dial(Element):
    ...
    def update(self, value=None, range=(None, None), disabled=None, visible=None):
        """
        Changes some of the settings for the Dial Element. Must call `Window.Read` or `Window.Finalize` prior

        Changes will not be visible in your window until you call window.read or window.refresh.

        If you change visibility, your element may MOVE.

        :param value:    sets current dial value
        :type value:     int | float
        :param range:    slider's range (min value, max value)
        :type range:     (int, int), (float, float)
        :param disabled: disable or enable state of the element
...
class Column(Element):
    ...
    def __init__(self, layout, background_color=None, element_justification='float', size=(None, None), pad=None, scrollable=False, key=None, k=None, visible=True, metadata=None):
        ...
        :type layout:                 List[List[Element]]
        :param background_color:      color of background of entire Column. Can be in #RRGGBB format or a color name "black"
        :type background_color:       (str)
...
class Menu(Element):
    ...
    def __init__(self, menu_definition, background_color=None, size=(None, None), tearoff=False, pad=None, key=None, k=None, visible=True, metadata=None):
        ...
        :param background_color: color of the background of menus, NOT the Menubar. Can be in #RRGGBB format or a color name "black"
        :type background_color:  (str)
    ...
    def update(self, menu_definition=None, visible=None):
        ...
        if menu_definition is not None:
            ...
            for menu_entry in menu_def:
                ...
                _AddMenuItem(baritem, menu_entry[1], self)
...
class Table(Element):
    ...
    def _qt_callback_cell_activated(self, value=None):
        """
        Not user callable!
        """
    ...
    def _qt_callback_vertical_header(self, value):
        """
        Not user callable!
        """
    ...
    _QtCallbackCellActivated = _qt_callback_cell_activated
    _QtCallbackVerticalHeader = _qt_callback_vertical_header
    Update = update
    Get = get
...
class SystemTray:
    ...
    def __init__(self, menu=None, filename=None, data=None, data_base64=None, tooltip=None, metadata=None):
        ...
        if self.Menu is not None:
            ...
            _AddTrayMenuItem(qmenu, self.Menu[1], self)
    ...
    def read(self, timeout=None):
        ...
        if not self.Shown:
            ...
            self.TrayIcon.show()
        if timeout is None:
            pyside_exec(self.App)
        elif timeout == 0:
            self.App.processEvents()
        else:
            self.timer = _start_systray_read_timer(self, timeout)
            pyside_exec(self.App)
    ...
    def show_message(self, title, message, filename=None, data=None, data_base64=None, messageicon=None, time=10000):
        """
...
class Window:
    ...
    @classmethod
    def _decrement_open_count(self):
        """
    ...
    def layout_and_read(self, rows, non_blocking=False):
        """
    ...
    def _read(self, timeout=None, timeout_key=TIMEOUT_KEY):
        ...
        if not self.Shown:
            ...
            if timeout != None:
                self.TimerCancelled = False
                timer = _start_window_read_timer(self, timeout)
            else:
                timer = None
            ...
            pyside_exec(self.QTApplication)
    ...
    def _keyboard_callback(self, event):
        """
        Window keyboard callback. Will kick user out of the event loop. Should only be
    ...
    def _mouse_wheel_callback(self, event):
        """
        Called when a mouse wheel event has happened. Only called if keyboard events for the window
        have been enabled
    ...
    def size(self):
        ...
        :rtype:  List[(int), (int)] or Tuple[None, None]
        """
    ...
    _IncrementOpenCount = _increment_open_count
    _DecrementOpenCount = _decrement_open_count
    _AddRow = _add_row
    _AddRows = _add_rows
    Layout = layout
    LayoutAndRead = layout_and_read
    LayoutAndShow = layout_and_show
    _Show = _show
    SetIcon = set_icon
    _GetElementAtLocation = _get_element_at_location
    _GetDefaultElementSize = _get_default_element_size
    _AutoCloseAlarmCallback = _auto_close_alarm_callback
    Read = read
    _ReadNonBlocking = _read_non_blocking
    Finalize = finalize
    Refresh = refresh
    VisibilityChanged = visibility_changed
    Fill = fill
    FindElement = find_element
    _BuildKeyDict = _build_key_dict
    _BuildKeyDictForWindow = _build_key_dict_for_window
    ...
    Minimize = minimize
    Maximize = maximize
    _StartMove = _start_move
    _StopMove = _stop_move
    _OnMotion = _on_motion
    _KeyboardCallback = _keyboard_callback
    _MouseWheelCallback = _mouse_wheel_callback
    _Close = _close
    Close = close
    Disable = disable
    Enable = enable
...
class QtStyle(object):
    ...
    def __setitem__(self, css_prop_name, css_prop_value):
        ...
        if self.make_secure_check:
            if not _is_valid_css_prop(css_prop_name):
...
def _convert_tkinter_size_to_Qt(size, scaling=DEFAULT_PIXELS_TO_CHARS_SCALING, height_cutoff=DEFAULT_PIXEL_TO_CHARS_CUTOFF):
    ...
    :type size:
    :param scaling:       scalling
    :type scaling:
    :param height_cutoff: height cutoff
    :type height_cutoff:
...
def convert_tkinter_filetypes_to_qt(filetypes):
    """
    Convert tkinter filetypes toqt
    :param filetypes: ???
    :type filetypes:  ???
    :return:          ???
    :rtype:           ???
...
def _add_to_return_dictionary(form, element, value):
...
def _decode_radio_row_col(RadValue):
    row = RadValue // 1000
    col = RadValue % 1000
    return row, col


def _encode_radio_row_col(row, col):
...
def _build_results_for_subform(form, initialize_only, top_level_form):
        ...
        for col_num, element in enumerate(row):
            ...
            if element.Type == ELEM_TYPE_COLUMN:
                ...
                for item in element.ReturnValuesList:
                    _AddToReturnList(top_level_form, item)
            ...
            if not initialize_only:
                if element.Type == ELEM_TYPE_INPUT_TEXT:
                    ...
                    this_rowcol = _EncodeRadioRowCol(row_num, col_num)
            ...
            if element.Type != ELEM_TYPE_BUTTON and \
                ...
                _AddToReturnList(form, value)
                _AddToReturnDictionary(top_level_form, element, value)
...
def _fill_form_with_values(form, values_dict):
    """
...
def _fill_subform_with_values(form, values_dict):
    for row_num, row in enumerate(form.Rows):
        for col_num, element in enumerate(row):
            value = None
            if element.Type == ELEM_TYPE_COLUMN:
...
def _find_element_from_key_in_sub_form(form, key):
    for row_num, row in enumerate(form.Rows):
        for col_num, element in enumerate(row):
            if element.Type == ELEM_TYPE_COLUMN:
...
def _find_element_with_focus_in_sub_form(form):
    """
...
def _add_tray_menu_item(top_menu, sub_menu_info, element, is_sub_menu=False, skip=False):
    """
        ...
        while i < (len(sub_menu_info)):
            ...
            if i != len(sub_menu_info) - 1:
                if type(sub_menu_info[i + 1]) is list:
                    ...
                    _AddTrayMenuItem(new_menu, sub_menu_info[i + 1], element, is_sub_menu=True)
                    i += 1  # skip the next one
                else:
                    _AddTrayMenuItem(top_menu, item, element)
            else:
                _AddTrayMenuItem(top_menu, item, element)
            i += 1


def _add_menu_item(top_menu, sub_menu_info, element, is_sub_menu=False, skip=False):
    """
    Only to be used internally. Not user callable
    :param top_menu:      ???
    :type top_menu:       ???
        ...
        while i < (len(sub_menu_info)):
            ...
            if i != len(sub_menu_info) - 1:
                if type(sub_menu_info[i + 1]) is list:
                    ...
                    top_menu.addAction(new_menu.menuAction())
                    # print(f'Adding submenu {sub_menu_info[i]}')
                    _AddMenuItem(new_menu, sub_menu_info[i + 1], element, is_sub_menu=True)
                    i += 1  # skip the next one
                else:
                    _AddMenuItem(top_menu, item, element)
            else:
                _AddMenuItem(top_menu, item, element)
            i += 1


_AddToReturnDictionary = _add_to_return_dictionary
_AddToReturnList = _add_to_return_list
_InitializeResults = _initialize_results
_DecodeRadioRowCol = _decode_radio_row_col
_EncodeRadioRowCol = _encode_radio_row_col
_BuildResults = _build_results
_BuildResultsForSubform = _build_results_for_subform
_FillFormWithValues = _fill_form_with_values
_FillSubformWithValues = _fill_subform_with_values
_FindElementFromKeyInSubForm =  _find_element_from_key_in_sub_form
_FindElementWithFocusInSubForm = _find_element_with_focus_in_sub_form
_AddTrayMenuItem = _add_tray_menu_item
_AddMenuItem = _add_menu_item
...
def _is_valid_css_prop(a_css_prop):
    """
    Not user callable!
...
def _pack_form_into_frame(container_elem, containing_frame, toplevel_win):
    """
    ...
    for row_num, flex_row in enumerate(container_elem.Rows):
        ...
        for col_num, element in enumerate(flex_row):
            ...
            if element_type == ELEM_TYPE_COLUMN:
                ...
                _PackFormIntoFrame(element, column_layout, toplevel_win)
            ...
            # -------------------------  INPUT CHECKBOX placement element  ------------------------- #
                ...
                if element.ChangeSubmits:
                    element.QT_Checkbox.stateChanged.connect(element._QtCallbackStateChanged)
                # qt_row_layout.setContentsMargins(*full_element_pad)
                if element.Tooltip:
            ...
            # -------------------------  IMAGE placement element  ------------------------- #
                ...
                if element.ClickSubmits:
                    element.QT_QLabel.mousePressEvent = element._QtCallbackImageClicked
                if not element.Visible:
            ...
            # -------------------------  MENUBAR placement element  ------------------------- #
                ...
                for menu_entry in menu_def:
                    ...
                    _AddMenuItem(baritem, menu_entry[1], element)
                    # === style ===
            ...
            # -------------------------  BUTTONMENU placement element  ------------------------- #
                ...
                qmenu.setTitle(menu_def[0])
                _AddMenuItem(qmenu, menu_def[1], element)
            ...
            # -------------------------  TabGroup placement element  ------------------------- #
                ...
                _PackFormIntoFrame(element, element.ParentForm.QFormLayout, toplevel_win)
                ...
                if element.ChangeSubmits:
                    element.QT_QTabWidget.currentChanged.connect(element._QtCallbackStateChanged)
...
def _convert_flex_to_tk(window):
    """
    Not user callable!
    """

    _InitializeResults(window)
    master = 000000
    _PackFormIntoFrame(window, window.QFormLayout, window)
...
# ----====----====----====----====----==== Start timer ====----====----====----====----====----#
def _start_window_read_timer(window, amount):
    """
    Not user callable!
    """
...
def _start_systray_read_timer(tray, amount):
    """
    Not user callable!
    """
...
def _start_window_autoclose_timer(window, amount):
    """
    Not user callable!
    """
...
def _startup_tk(window):
    ...
    if not qt_version and flags is not None:
    ...
    timer = None
    if window.AutoClose:
        timer = _start_window_autoclose_timer(window, window.AutoCloseDuration * 1000)

    if not window.NonBlocking:
        if window.Timeout:
            timer = _start_window_read_timer(window, window.Timeout)
        window.QT_QMainWindow.show()              ####### The thing that causes the window to be visible ######
        #### ------------------------------ RUN MAIN LOOP HERE ------------------------------ #####
        pyside_exec(window.QTApplication)
        if timer:
            _stop_timer(timer)
...
# ===================================================#
def _get_num_lines_needed(text, max_line_width):
    """
    Helper function for determining how to wrap text
    :param text:
    :type text:
...
def _convert_args_to_single_string(*args):
    """
    :param *args:
    :type *args:
    """
...
_PackFormIntoFrame = _pack_form_into_frame
_ConvertFlexToTK = _convert_flex_to_tk
_StartupTK = _startup_tk
_GetNumLinesNeeded = _get_num_lines_needed
_ConvertArgsToSingleString = _convert_args_to_single_string
...
class QuickMeter(object):
    ...
    def __init__(self, title, current_value, max_value, key, *args, orientation='v', bar_color=(None, None),
        ...
        self.window = self._BuildWindow(*args)
    ...
    _BuildWindow = _build_window
    _UpdateMeter = _update_meter
    _ComputeProgressStats = _compute_progress_stats


def _one_line_progress_meter(title, current_value, max_value, key='OK for 1 meter', *args, orientation='v', bar_color=(None, None),
    ...
    rc = meter._UpdateMeter(current_value, max_value, *args)
    _OneLineProgressMeter.exit_reasons = getattr(_OneLineProgressMeter, 'exit_reasons', QuickMeter.exit_reasons)
    return rc == METER_OK


def _one_line_progress_meter_cancel(key='OK for 1 meter'):
    """
...
# input is #RRGGBB
# output is #RRGGBB
def _get_complimentary_hex(color):
    """
...
_OneLineProgressMeter = _one_line_progress_meter
_OneLineProgressMeterCancel = _one_line_progress_meter_cancel
_GetComplimentaryHex = _get_complimentary_hex
...
class DebugWin():
    ...
    def __init__(self, size=(None, None), location=(None, None), font=None, no_titlebar=False, no_button=False,
        ...
        self.window._AddRows(self.layout)
...
def easy_print(*args, size=(None, None), end=None, sep=None, location=(None, None), font=None, no_titlebar=False,
    ...
    DebugWin.debug_window._Print(*args, end=end, sep=sep)
...
def easy_print_close():
    ...
    if DebugWin.debug_window is not None:
        DebugWin.debug_window._Close()
        DebugWin.debug_window = None


PrintClose = print_close
...
# ========================  Scrolled Text Box   =====#
# ===================================================#
def popup_scrolled(*args, button_color=None, yes_no=False, auto_close=False, auto_close_duration=None,
    ...
    window._AddRow(MultilineOutput(complete_output, size=computed_size))
    pad = max_line_total - 15 if max_line_total > 15 else 1
    # show either an OK or Yes/No depending on paramater
    button = DummyButton if non_blocking else Button
    if yes_no:
        window._AddRow(Text('', size=(pad, 1), auto_size_text=False), button('Yes'), button('No'))
    else:
        window._AddRow(Text('', size=(pad, 1), auto_size_text=False),
...
# --------------------------- PopupNoButtons ---------------------------
def popup_no_buttons(*args, title=None, button_color=None, background_color=None, text_color=None, auto_close=False,
...
# --------------------------- PopupNonBlocking ---------------------------
def popup_non_blocking(*args, title=None, button_type=POPUP_BUTTONS_OK, button_color=None, background_color=None, text_color=None,
...
def popup_quick(*args, title=None, button_type=POPUP_BUTTONS_OK, button_color=None, background_color=None, text_color=None,
...
# --------------------------- PopupNoTitlebar ---------------------------
def popup_no_titlebar(*args, title=None, button_type=POPUP_BUTTONS_OK, button_color=None, background_color=None, text_color=None,
...
def popup_get_file(message, title=None, default_path='', default_extension='', save_as=False, file_types=(("ALL Files", "*"),),
...
def main():
    ...
    layout = [
        ...
        [Text('You are running the PySimpleGUIQt.py file itself', font=('ANY', 15, 'Bold'), text_color='yellow')],
...
class UserSettings:
    ...
    def save(self, filename=None, path=None):
        ...
        try:
            ...
            if not self.silent_on_error:
                popup_error('UserSettings.save error', '*** UserSettings.save()  Error saving settings to file:***\n', self.full_filename, e)
    ...
    def delete_file(self, filename=None, path=None, report_error=False):
        ...
        try:
            ...
            if report_error:
                popup_error('UserSettings delete_file warning ***', 'Exception trying to perform os.remove', e)
        self.dict = {}
    ...
    def read(self):
        ...
        try:
            ...
            if not self.silent_on_error:
                popup_error('User Settings read warning', 'Error reading settings from file', self.full_filename, e)
        ...
        if not self.use_config_file:  # Is using JSON file
            if key in self.dict:
                ...
                if silent_on_error is False or (silent_on_error is not True and not self.silent_on_error):
                    popup_error('User Settings delete_entry Warning - key', key, ' not found in settings')
...
def get_license_popup():
    """
    Prompt for agreeing with the license.
    ...
    URL_GET_LICENSE = r'http://signup.PySimpleGUI.com'
    URL_PRIVACY = r'http://privacy.PySimpleGUI.com'
    URL_TERMS = r'http://terms.PySimpleGUI.com'
    URL_LICENSE = r'http://license.PySimpleGUI.com'

    layout = [
                [Image(data_base64=EMOJI_BASE64_WAVE), Text("PySimpleGUIQt Subscription", font=('Arial Bold', 25))],
                [Text("\nPySimpleGUIQt now requires a PySimpleGUI 5 subscription.\nClick the sign up button below to obtain one.\n", font=('Arial', 15), justification='left')],
                [Checkbox("I have read and agree to the:", key='-CHECKBOX AGREE-', enable_events=True)],
                [Image(pad=(7, 0)), Text("license agreement", key='-BUTTON LICENSE-', enable_events=True, text_color="white"), Text("terms of use", key='-BUTTON TOS-', enable_events=True, text_color="white"), Text("and privacy policy", key='-BUTTON PRIVACY-', enable_events=True, text_color="white")],
                [Checkbox("I have obtained a PySimpleGUI 5 License", key='-CHECKBOX LICENSE-', enable_events=True)],
                [Image(pad=(150, 0)), Button("Sign Up", key='-BUTTON SIGNUP-', font=('Arial Bold', 10), size=(7, 1)), Button("Cancel", font=('Arial Bold', 10), size=(7, 1), button_color=("white", "gray")), Button("Continue", font=('Arial Bold', 10), size=(7, 1), key='-BUTTON CONTINUE-', button_color=("white", "grey"), disabled=True)]
            ]

    window = Window('PySimpleGUI Install', layout, finalize=True)

    while True:
        event, values = window.read()
        if event == None or event == 'Cancel':
            break
        elif event == '-BUTTON SIGNUP-':
            webbrowser.open(URL_GET_LICENSE)
        elif event == '-BUTTON LICENSE-':
            webbrowser.open(URL_LICENSE)
        elif event == '-BUTTON TOS-':
            webbrowser.open(URL_TERMS)
        elif event == '-BUTTON PRIVACY-':
            webbrowser.open(URL_PRIVACY)
        elif event in ['-CHECKBOX LICENSE-', '-CHECKBOX AGREE-']:
            if values['-CHECKBOX LICENSE-'] and values['-CHECKBOX AGREE-']:
                window['-BUTTON CONTINUE-'].update(disabled=False, button_color=("white", "green"))
            else:
                window['-BUTTON CONTINUE-'].update(disabled=True, button_color=("white", "grey"))
        elif event == '-BUTTON CONTINUE-':
            agreed = True
            break
    window.close()
    return agreed
...
if not pysimplegui_user_settings['-QT License-']:
    if not get_license_popup():
        popup_error('Must agree with licnse')
        exit()
    pysimplegui_user_settings['-QT License-'] = True
