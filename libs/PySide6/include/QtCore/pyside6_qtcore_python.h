...
enum [[deprecated]] : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 944,
    ...
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 330,
    SBK_QFUTUREINTERFACEBASE_CONTINUATIONTYPE_IDX            = 328,
    SBK_QFUTUREINTERFACEBASE_CANCELMODE_IDX                  = 326,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 324,
    SBK_QGENERICARGUMENT_IDX                                 = 332,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 334,
    SBK_QHASHSEED_IDX                                        = 336,
    SBK_QIODEVICE_IDX                                        = 338,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 342,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 238,
    SBK_QIODEVICEBASE_IDX                                    = 340,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 344,
    SBK_QITEMSELECTION_IDX                                   = 346,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 350,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 240,
    SBK_QITEMSELECTIONMODEL_IDX                              = 348,
    SBK_QITEMSELECTIONRANGE_IDX                              = 352,
    SBK_QJSONARRAY_IDX                                       = 354,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 358,
    SBK_QJSONDOCUMENT_IDX                                    = 356,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 362,
    SBK_QJSONPARSEERROR_IDX                                  = 360,
    SBK_QJSONVALUE_TYPE_IDX                                  = 366,
    SBK_QJSONVALUE_IDX                                       = 364,
    SBK_QKEYCOMBINATION_IDX                                  = 368,
    SBK_QLIBRARY_LOADHINT_IDX                                = 372,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 242,
    SBK_QLIBRARY_IDX                                         = 370,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 376,
    SBK_QLIBRARYINFO_IDX                                     = 374,
    SBK_QLINE_IDX                                            = 378,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 382,
    SBK_QLINEF_IDX                                           = 380,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 394,
    SBK_QLOCALE_SCRIPT_IDX                                   = 950,
    SBK_QLOCALE_COUNTRY_IDX                                  = 386,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 398,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 392,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 400,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 248,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 390,
    SBK_QLOCALE_TAGSEPARATOR_IDX                             = 402,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 946,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 388,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 244,
    SBK_QLOCALE_LANGUAGECODETYPE_IDX                         = 396,
    SBK_QFLAGS_QLOCALE_LANGUAGECODETYPE_IDX                  = 246,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 948,
    SBK_QLOCALE_IDX                                          = 384,
    SBK_QLOCATIONPERMISSION_ACCURACY_IDX                     = 406,
    SBK_QLOCATIONPERMISSION_AVAILABILITY_IDX                 = 408,
    SBK_QLOCATIONPERMISSION_IDX                              = 404,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 412,
    SBK_QLOCKFILE_IDX                                        = 410,
    SBK_QLOGGINGCATEGORY_IDX                                 = 414,
    SBK_QMARGINS_IDX                                         = 416,
    SBK_QMARGINSF_IDX                                        = 418,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 420,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 422,
    SBK_QMESSAGELOGGER_IDX                                   = 424,
    SBK_QMETACLASSINFO_IDX                                   = 426,
    SBK_QMETAENUM_IDX                                        = 428,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 432,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 434,
    SBK_QMETAMETHOD_IDX                                      = 430,
    SBK_QMETAOBJECT_CALL_IDX                                 = 438,
    SBK_QMETAOBJECT_IDX                                      = 436,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 440,
    SBK_QMETAPROPERTY_IDX                                    = 442,
    SBK_QMETATYPE_TYPE_IDX                                   = 446,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 448,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 250,
    SBK_QMETATYPE_IDX                                        = 444,
    SBK_QMICROPHONEPERMISSION_IDX                            = 450,
    SBK_QMIMEDATA_IDX                                        = 452,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 456,
    SBK_QMIMEDATABASE_IDX                                    = 454,
    SBK_QMIMETYPE_IDX                                        = 458,
    SBK_QMODELINDEX_IDX                                      = 460,
    SBK_QMODELROLEDATA_IDX                                   = 462,
    SBK_QMODELROLEDATASPAN_IDX                               = 464,
    SBK_QMUTEX_IDX                                           = 466,
    SBK_QNATIVEIPCKEY_TYPE_IDX                               = 470,
    SBK_QNATIVEIPCKEY_IDX                                    = 468,
    SBK_QOBJECT_IDX                                          = 472,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 476,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 474,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 478,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 480,
    SBK_QPAUSEANIMATION_IDX                                  = 482,
    SBK_QPERMISSION_IDX                                      = 484,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 486,
    SBK_QPLUGINLOADER_IDX                                    = 488,
    SBK_QPOINT_IDX                                           = 490,
    SBK_QPOINTF_IDX                                          = 492,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 504,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 506,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 500,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 502,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 498,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 496,
    SBK_QPROCESS_UNIXPROCESSFLAG_IDX                         = 508,
    SBK_QFLAGS_QPROCESS_UNIXPROCESSFLAG_IDX                  = 252,
    SBK_QPROCESS_IDX                                         = 494,
    SBK_QPROCESS_UNIXPROCESSPARAMETERS_IDX                   = 510,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 514,
    SBK_QPROCESSENVIRONMENT_IDX                              = 512,
    SBK_QPROPERTYANIMATION_IDX                               = 516,
    SBK_QRANDOMGENERATOR_IDX                                 = 518,
    SBK_QRANDOMGENERATOR64_IDX                               = 520,
    SBK_QRANGEMODEL_ROWCATEGORY_IDX                          = 524,
    SBK_QRANGEMODEL_IDX                                      = 522,
    SBK_QREADLOCKER_IDX                                      = 526,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 530,
    SBK_QREADWRITELOCK_IDX                                   = 528,
    SBK_QRECT_IDX                                            = 532,
    SBK_QRECTF_IDX                                           = 534,
    SBK_QRECURSIVEMUTEX_IDX                                  = 536,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 544,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 256,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 542,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 540,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 254,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 546,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 258,
    SBK_QREGULAREXPRESSION_IDX                               = 538,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 548,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 550,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 554,
    SBK_QRESOURCE_IDX                                        = 552,
    SBK_QRUNNABLE_IDX                                        = 556,
    SBK_QSAVEFILE_IDX                                        = 558,
    SBK_QSEMAPHORE_IDX                                       = 560,
    SBK_QSEMAPHORERELEASER_IDX                               = 562,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 564,
    SBK_QSETTINGS_STATUS_IDX                                 = 572,
    SBK_QSETTINGS_FORMAT_IDX                                 = 568,
    SBK_QSETTINGS_SCOPE_IDX                                  = 570,
    SBK_QSETTINGS_IDX                                        = 566,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 576,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 578,
    SBK_QSHAREDMEMORY_IDX                                    = 574,
    SBK_QSIGNALBLOCKER_IDX                                   = 580,
    SBK_QSIGNALMAPPER_IDX                                    = 582,
    SBK_QSIZE_IDX                                            = 584,
    SBK_QSIZEF_IDX                                           = 586,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 588,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 592,
    SBK_QSOCKETNOTIFIER_IDX                                  = 590,
    SBK_QSORTFILTERPROXYMODEL_DIRECTION_IDX                  = 596,
    SBK_QFLAGS_QSORTFILTERPROXYMODEL_DIRECTION_IDX           = 260,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 594,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 602,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 600,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 262,
    SBK_QSTANDARDPATHS_IDX                                   = 598,
    SBK_QSTORAGEINFO_IDX                                     = 604,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 608,
    SBK_QSTRINGCONVERTER_IDX                                 = 606,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 612,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 264,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 610,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 614,
    SBK_QSTRINGDECODER_IDX                                   = 616,
    SBK_QSTRINGENCODER_IDX                                   = 618,
    SBK_QSTRINGLISTMODEL_IDX                                 = 620,
    SBK_QSYSINFO_SIZES_IDX                                   = 626,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 624,
    SBK_QSYSINFO_IDX                                         = 622,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 630,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 632,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 628,
    SBK_QTEMPORARYDIR_IDX                                    = 634,
    SBK_QTEMPORARYFILE_IDX                                   = 636,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 642,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 640,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 266,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 638,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 650,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 646,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 652,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 648,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 268,
    SBK_QTEXTSTREAM_IDX                                      = 644,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 654,
    SBK_QTHREAD_PRIORITY_IDX                                 = 658,
    SBK_QTHREAD_QUALITYOFSERVICE_IDX                         = 660,
    SBK_QTHREAD_IDX                                          = 656,
    SBK_QTHREADPOOL_IDX                                      = 662,
    SBK_QTIME_IDX                                            = 664,
    SBK_QTIMELINE_STATE_IDX                                  = 670,
    SBK_QTIMELINE_DIRECTION_IDX                              = 668,
    SBK_QTIMELINE_IDX                                        = 666,
    SBK_QTIMEZONE_INITIALIZATION_IDX                         = 674,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 680,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 676,
    SBK_QTIMEZONE_IDX                                        = 672,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 678,
    SBK_QTIMER_IDX                                           = 682,
    SBK_QTIMEREVENT_IDX                                      = 684,
    SBK_QTRANSLATOR_IDX                                      = 686,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 688,
    SBK_QURL_PARSINGMODE_IDX                                 = 696,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 698,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 694,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 272,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 700,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 276,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 692,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 270,
    SBK_QURL_IDX                                             = 690,
    SBK_QURLQUERY_IDX                                        = 702,
    SBK_QUUID_VARIANT_IDX                                    = 708,
    SBK_QUUID_VERSION_IDX                                    = 710,
    SBK_QUUID_STRINGFORMAT_IDX                               = 706,
    SBK_QUUID_IDX                                            = 704,
    SBK_QVARIANTANIMATION_IDX                                = 712,
    SBK_QVERSIONNUMBER_IDX                                   = 714,
    SBK_QWAITCONDITION_IDX                                   = 716,
    SBK_QWRITELOCKER_IDX                                     = 718,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 720,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 722,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 724,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 726,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 728,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 730,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 738,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 736,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 734,
    SBK_QXMLSTREAMREADER_IDX                                 = 732,
    SBK_QXMLSTREAMWRITER_ERROR_IDX                           = 742,
    SBK_QXMLSTREAMWRITER_IDX                                 = 740,
    SBK_QT_GLOBALCOLOR_IDX                                   = 818,
    SBK_QT_COLORSCHEME_IDX                                   = 772,
    SBK_QT_CONTRASTPREFERENCE_IDX                            = 780,
    SBK_QT_MOUSEBUTTON_IDX                                   = 850,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 304,
    SBK_QT_ORIENTATION_IDX                                   = 860,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 308,
    SBK_QT_FOCUSPOLICY_IDX                                   = 808,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 888,
    SBK_QT_SORTORDER_IDX                                     = 884,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 886,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 312,
    SBK_QT_TILERULE_IDX                                      = 898,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 746,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 278,
    SBK_QT_TEXTFLAG_IDX                                      = 892,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 890,
    SBK_QT_WHITESPACEMODE_IDX                                = 918,
    SBK_QT_HITTESTACCURACY_IDX                               = 822,
    SBK_QT_WINDOWTYPE_IDX                                    = 928,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 322,
    SBK_QT_WINDOWSTATE_IDX                                   = 926,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 320,
    SBK_QT_APPLICATIONSTATE_IDX                              = 752,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 280,
    SBK_QT_SCREENORIENTATION_IDX                             = 872,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 310,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 920,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 750,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 824,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 292,
    SBK_QT_BGMODE_IDX                                        = 760,
    SBK_QT_KEY_IDX                                           = 838,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 840,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 300,
    SBK_QT_MODIFIER_IDX                                      = 848,
    SBK_QT_ARROWTYPE_IDX                                     = 754,
    SBK_QT_PENSTYLE_IDX                                      = 866,
    SBK_QT_PENCAPSTYLE_IDX                                   = 862,
    SBK_QT_PENJOINSTYLE_IDX                                  = 864,
    SBK_QT_BRUSHSTYLE_IDX                                    = 762,
    SBK_QT_SIZEMODE_IDX                                      = 882,
    SBK_QT_UIEFFECT_IDX                                      = 916,
    SBK_QT_CURSORSHAPE_IDX                                   = 786,
    SBK_QT_TEXTFORMAT_IDX                                    = 894,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 756,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 792,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 282,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 794,
    SBK_QT_TOOLBARAREA_IDX                                   = 906,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 316,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 908,
    SBK_QT_DATEFORMAT_IDX                                    = 788,
    SBK_QT_TIMESPEC_IDX                                      = 900,
    SBK_QT_DAYOFWEEK_IDX                                     = 790,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 874,
    SBK_QT_CASESENSITIVITY_IDX                               = 764,
    SBK_QT_CORNER_IDX                                        = 784,
    SBK_QT_EDGE_IDX                                          = 798,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 286,
    SBK_QT_CONNECTIONTYPE_IDX                                = 774,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 878,
    SBK_QT_FILLRULE_IDX                                      = 804,
    SBK_QT_MASKMODE_IDX                                      = 844,
    SBK_QT_CLIPOPERATION_IDX                                 = 770,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 834,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 836,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 914,
    SBK_QT_AXIS_IDX                                          = 758,
    SBK_QT_FOCUSREASON_IDX                                   = 810,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 776,
    SBK_QT_CONTEXTMENUTRIGGER_IDX                            = 778,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 828,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 296,
    SBK_QT_INPUTMETHODHINT_IDX                               = 826,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 294,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 800,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 910,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 842,
    SBK_QT_ANCHORPOINT_IDX                                   = 748,
    SBK_QT_FINDCHILDOPTION_IDX                               = 806,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 288,
    SBK_QT_DROPACTION_IDX                                    = 796,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 284,
    SBK_QT_CHECKSTATE_IDX                                    = 766,
    SBK_QT_ITEMDATAROLE_IDX                                  = 830,
    SBK_QT_ITEMFLAG_IDX                                      = 832,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 298,
    SBK_QT_MATCHFLAG_IDX                                     = 846,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 302,
    SBK_QT_WINDOWMODALITY_IDX                                = 924,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 896,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 314,
    SBK_QT_EVENTPRIORITY_IDX                                 = 802,
    SBK_QT_SIZEHINT_IDX                                      = 880,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 922,
    SBK_QT_COORDINATESYSTEM_IDX                              = 782,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 912,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 318,
    SBK_QT_GESTURESTATE_IDX                                  = 814,
    SBK_QT_GESTURETYPE_IDX                                   = 816,
    SBK_QT_GESTUREFLAG_IDX                                   = 812,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 290,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 856,
    SBK_QT_NAVIGATIONMODE_IDX                                = 858,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 952,
    SBK_QT_TIMERTYPE_IDX                                     = 904,
    SBK_QT_TIMERID_IDX                                       = 902,
    SBK_QT_SCROLLPHASE_IDX                                   = 876,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 854,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 852,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 306,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 768,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 820,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 868,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 870,
    SBK_QTCOREQT_IDX                                         = 744,
    SBK_QTCOREHELPER_QDIRLISTINGITERATOR_IDX                 = 932,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 934,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 936,
    SBK_QTCOREHELPER_QIOPIPE_IDX                             = 938,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 940,
    SBK_QCBORKNOWNTAGS_IDX                                   = 72,
    SBK_QCBORSIMPLETYPE_IDX                                  = 78,
    SBK_QCBORTAG_IDX                                         = 92,
    SBK_QTMSGTYPE_IDX                                        = 942,
    SBK_QTCORE_IDX_COUNT                                     = 954,
};
...
enum : int {
    ...
    SBK_QProcess_UnixProcessFlag_IDX                         = 254,
    SBK_QFlags_QProcess_UnixProcessFlag_IDX                  = 126,
    SBK_QProcess_IDX                                         = 247,
    SBK_QProcess_UnixProcessParameters_IDX                   = 255,
    SBK_QProcessEnvironment_Initialization_IDX               = 257,
    SBK_QProcessEnvironment_IDX                              = 256,
    SBK_QPropertyAnimation_IDX                               = 258,
    SBK_QRandomGenerator_IDX                                 = 259,
    SBK_QRandomGenerator64_IDX                               = 260,
    SBK_QRangeModel_RowCategory_IDX                          = 262,
    SBK_QRangeModel_IDX                                      = 261,
    SBK_QReadLocker_IDX                                      = 263,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 265,
    SBK_QReadWriteLock_IDX                                   = 264,
    SBK_QRect_IDX                                            = 266,
    SBK_QRectF_IDX                                           = 267,
    SBK_QRecursiveMutex_IDX                                  = 268,
    SBK_QRegularExpression_PatternOption_IDX                 = 272,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 128,
    SBK_QRegularExpression_MatchType_IDX                     = 271,
    SBK_QRegularExpression_MatchOption_IDX                   = 270,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 127,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 273,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 129,
    SBK_QRegularExpression_IDX                               = 269,
    SBK_QRegularExpressionMatch_IDX                          = 274,
    SBK_QRegularExpressionMatchIterator_IDX                  = 275,
    SBK_QResource_Compression_IDX                            = 277,
    SBK_QResource_IDX                                        = 276,
    SBK_QRunnable_IDX                                        = 278,
    SBK_QSaveFile_IDX                                        = 279,
    SBK_QSemaphore_IDX                                       = 280,
    SBK_QSemaphoreReleaser_IDX                               = 281,
    SBK_QSequentialAnimationGroup_IDX                        = 282,
    SBK_QSettings_Status_IDX                                 = 286,
    SBK_QSettings_Format_IDX                                 = 284,
    SBK_QSettings_Scope_IDX                                  = 285,
    SBK_QSettings_IDX                                        = 283,
    SBK_QSharedMemory_AccessMode_IDX                         = 288,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 289,
    SBK_QSharedMemory_IDX                                    = 287,
    SBK_QSignalBlocker_IDX                                   = 290,
    SBK_QSignalMapper_IDX                                    = 291,
    SBK_QSize_IDX                                            = 292,
    SBK_QSizeF_IDX                                           = 293,
    SBK_QSocketDescriptor_IDX                                = 294,
    SBK_QSocketNotifier_Type_IDX                             = 296,
    SBK_QSocketNotifier_IDX                                  = 295,
    SBK_QSortFilterProxyModel_Direction_IDX                  = 298,
    SBK_QFlags_QSortFilterProxyModel_Direction_IDX           = 130,
    SBK_QSortFilterProxyModel_IDX                            = 297,
    SBK_QStandardPaths_StandardLocation_IDX                  = 301,
    SBK_QStandardPaths_LocateOption_IDX                      = 300,
    SBK_QFlags_QStandardPaths_LocateOption_IDX               = 131,
    SBK_QStandardPaths_IDX                                   = 299,
    SBK_QStorageInfo_IDX                                     = 302,
    SBK_QStringConverter_Encoding_IDX                        = 304,
    SBK_QStringConverter_IDX                                 = 303,
    SBK_QStringConverterBase_Flag_IDX                        = 306,
    SBK_QFlags_QStringConverterBase_Flag_IDX                 = 132,
    SBK_QStringConverterBase_IDX                             = 305,
    SBK_QStringConverterBase_State_IDX                       = 307,
    SBK_QStringDecoder_IDX                                   = 308,
    SBK_QStringEncoder_IDX                                   = 309,
    SBK_QStringListModel_IDX                                 = 310,
    SBK_QSysInfo_Sizes_IDX                                   = 313,
    SBK_QSysInfo_Endian_IDX                                  = 312,
    SBK_QSysInfo_IDX                                         = 311,
    SBK_QSystemSemaphore_AccessMode_IDX                      = 315,
    SBK_QSystemSemaphore_SystemSemaphoreError_IDX            = 316,
    SBK_QSystemSemaphore_IDX                                 = 314,
    SBK_QTemporaryDir_IDX                                    = 317,
    SBK_QTemporaryFile_IDX                                   = 318,
    SBK_QTextBoundaryFinder_BoundaryType_IDX                 = 321,
    SBK_QTextBoundaryFinder_BoundaryReason_IDX               = 320,
    SBK_QFlags_QTextBoundaryFinder_BoundaryReason_IDX        = 133,
    SBK_QTextBoundaryFinder_IDX                              = 319,
    SBK_QTextStream_RealNumberNotation_IDX                   = 325,
    SBK_QTextStream_FieldAlignment_IDX                       = 323,
    SBK_QTextStream_Status_IDX                               = 326,
    SBK_QTextStream_NumberFlag_IDX                           = 324,
    SBK_QFlags_QTextStream_NumberFlag_IDX                    = 134,
    SBK_QTextStream_IDX                                      = 322,
    SBK_QTextStreamManipulator_IDX                           = 327,
    SBK_QThread_Priority_IDX                                 = 329,
    SBK_QThread_QualityOfService_IDX                         = 330,
    SBK_QThread_IDX                                          = 328,
    SBK_QThreadPool_IDX                                      = 331,
    SBK_QTime_IDX                                            = 332,
    SBK_QTimeLine_State_IDX                                  = 335,
    SBK_QTimeLine_Direction_IDX                              = 334,
    SBK_QTimeLine_IDX                                        = 333,
    SBK_QTimeZone_Initialization_IDX                         = 337,
    SBK_QTimeZone_TimeType_IDX                               = 340,
    SBK_QTimeZone_NameType_IDX                               = 338,
    SBK_QTimeZone_IDX                                        = 336,
    SBK_QTimeZone_OffsetData_IDX                             = 339,
    SBK_QTimer_IDX                                           = 341,
    SBK_QTimerEvent_IDX                                      = 342,
    SBK_QTranslator_IDX                                      = 343,
    SBK_QTransposeProxyModel_IDX                             = 344,
    SBK_QUrl_ParsingMode_IDX                                 = 348,
    SBK_QUrl_UrlFormattingOption_IDX                         = 349,
    SBK_QUrl_ComponentFormattingOption_IDX                   = 347,
    SBK_QFlags_QUrl_ComponentFormattingOption_IDX            = 136,
    SBK_QUrl_UserInputResolutionOption_IDX                   = 350,
    SBK_QFlags_QUrl_UserInputResolutionOption_IDX            = 138,
    SBK_QUrl_AceProcessingOption_IDX                         = 346,
    SBK_QFlags_QUrl_AceProcessingOption_IDX                  = 135,
    SBK_QUrl_IDX                                             = 345,
    SBK_QUrlQuery_IDX                                        = 351,
    SBK_QUuid_Variant_IDX                                    = 354,
    SBK_QUuid_Version_IDX                                    = 355,
    SBK_QUuid_StringFormat_IDX                               = 353,
    SBK_QUuid_IDX                                            = 352,
    SBK_QVariantAnimation_IDX                                = 356,
    SBK_QVersionNumber_IDX                                   = 357,
    SBK_QWaitCondition_IDX                                   = 358,
...
enum [[deprecated]] : int {
    ...
    SBK_QTCORE_QLIST_QURL_IDX                                = 35, // QList<QUrl>
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 36, // QList<QFileInfo>
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 37, // QList<QCommandLineOption>
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 38, // QHash<QString,QVariant>
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 39, // QMap<QString,QVariant>
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 40, // QList<QCborValue>
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 41, // QMap<int,QVariant>
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 42, // QList<QPersistentModelIndex>
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 43, // QHash<int,QByteArray>
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 44, // QList<QAbstractItemModel*>
    SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX  = 45, // QList<QAbstractEventDispatcher::TimerInfo>
    SBK_QTCORE_STD_PAIR_DOUBLE_QVARIANT_IDX                  = 46, // std::pair<double,QVariant>
    SBK_QTCORE_QLIST_STD_PAIR_DOUBLE_QVARIANT_IDX            = 47, // QList<std::pair<double,QVariant>>
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 48, // QList<QString>
    SBK_QTCORE_CONVERTERS_IDX_COUNT                          = 49,
};
